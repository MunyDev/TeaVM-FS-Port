...
//    	int fsize = (int) size;
     ...
     */
    public void close()  {
       fsIDB.getInternalStream(fstr, false, (n)->{
    	   FileSystemIDBOutputStream fsidbout = (FileSystemIDBOutputStream) n;
    	   fsidbout.seek(0);
    	   fsidbout.writeArrayBuffer(currentData.getBuffer());
    	   fsidbout.close();
